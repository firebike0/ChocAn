...
//This runs all of the accounting work at once.
public class SchedulerInterface 
{
	...
	public SchedulerInterface() 
	{
		...
		try
		{
			...
			ui.message("Creating the providers' reports ...");
			...
			ui.message("Creating the members' reports ...");
			...
			ui.message("Creating the accounts payable report ...");
